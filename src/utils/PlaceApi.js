export default class PlaceApi {
    ...
    static getGeometryForCountry(latitude, longitude) {
        return fetch(`https://maps.googleapis.com/maps/api/geocode/json?latlng=${latitude},${longitude}&result_type=country&key=AIzaSyApPL4vfjbQ_iVFrfE-97KN-ncf8i1NDLU`)
            .then(res => res.json())
            .then(country => {
                console.log(country)
